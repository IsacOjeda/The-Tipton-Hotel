...
<div class="continer">
	...
	<form:form action="/rooms/edit/${oneRoom.id }" method="put" modelAttribute="oneRoom">
	...
	<div class="form-floating mb-3">
		...
		<div class="container">
			<input type="submit" value="Update Room"></input>
		</div>	
	</form:form>
</div>
	
	<form action="/admin/delete/${oneRoom.id }" method="post">
